...
const defaultItems = [
    { letter: "C", icon: <FaGithub />, label: "Github", href: profile.links.github || "#" },
    { letter: "O", icon: <FaTwitter />, label: "Twitter", href: profile.links.twitter || "#" },
    { letter: "N", icon: <FaLinkedin />, label: "LinkedIn", href: profile.links.linkedin || "#" },
    { letter: "T", icon: <FaInstagram />, label: "Instagram", href: "#" },
    { letter: "A", icon: <FaFacebook />, label: "Facebook", href: "#" },
    { letter: "C", icon: <FaEnvelope />, label: "Email", href: profile.links.email || "#" },
...
const SocialFlipNode = ({
    ...
    return (
        <Wrapper
            {...wrapperProps}
            className={cn("relative h-10 w-10 md:h-12 md:w-12 cursor-pointer", itemClassName)}
...
export default function SocialFlipButton({
    ...
    return (
        <div className={cn("flex items-center justify-center gap-2 md:gap-4 p-4", className)}>
            <div
                className="group relative flex items-center justify-center gap-1.5 md:gap-2"
