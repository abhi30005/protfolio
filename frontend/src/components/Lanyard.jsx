...
function Band({
  ...
  const cardMap = useMemo(() => {
    ...
    const drawFitted = (img, rect) => {
      ...
      // Override default rectangle for completely filling the faces
      // In card.glb the left half is front and right half is back
      ...
      // Wipe the background to white to remove the base GLTF texture (like the black top band)
